...
@Component({
  selector: 'vex-realizar-recarga',
  templateUrl: './realizar-recarga.component.html',
  styleUrl: './realizar-recarga.component.scss',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    MatDialogModule,
...
export class RealizarRecargaComponent implements OnInit {
  ...
  form = this.fb.group({
    id: [RealizarRecargaComponent.id++],
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<RealizarRecargaComponent>,
